variables {
  ...
  // common variables
  //
  iso_url_8_x86_64       = "https://repo.almalinux.org/almalinux/8.7-beta/isos/x86_64/AlmaLinux-8.7-beta-1-x86_64-boot.iso"
  iso_checksum_8_x86_64  = "file:https://repo.almalinux.org/almalinux/8.7-beta/isos/x86_64/CHECKSUM"
  iso_url_8_aarch64      = "https://repo.almalinux.org/almalinux/8.7-beta/isos/aarch64/AlmaLinux-8.7-beta-1-aarch64-boot.iso"
  iso_checksum_8_aarch64 = "file:https://repo.almalinux.org/almalinux/8.7-beta/isos/aarch64/CHECKSUM"
  iso_url_8_ppc64le      = "https://repo.almalinux.org/almalinux/8.7-beta/isos/ppc64le/AlmaLinux-8.7-beta-1-ppc64le-boot.iso"
  iso_checksum_8_ppc64le = "file:https://repo.almalinux.org/almalinux/8.7-beta/isos/ppc64le/CHECKSUM"
  ...
  aws_ami_name_x86_64_8         = "AlmaLinux OS 8.7-beta-1.{{isotime \"20060102\"}} x86_64"
  aws_ami_name_aarch64_8        = "AlmaLinux OS 8.7-beta-1.{{isotime \"20060102\"}} aarch64"
  aws_ami_description_x86_64_8  = "Official AlmaLinux OS 8.7-beta x86_64 image"
  aws_ami_description_aarch64_8 = "Official AlmaLinux OS 8.7-beta aarch64 image"
  aws_ami_version_8             = "8.7-beta-1.{{isotime \"20060102\"}}"
  ...
  gencloud_boot_command_8_x86_64_uefi = [
    "c<wait>",
    "linuxefi /images/pxeboot/vmlinuz inst.stage2=hd:LABEL=AlmaLinux-8-7-beta-1-x86_64-dvd ro ",
  ...
  gencloud_boot_command_8_aarch64 = [
    "c<wait>",
    "linux /images/pxeboot/vmlinuz inst.stage2=hd:LABEL=AlmaLinux-8-7-beta-1-aarch64-dvd ro ",
    "inst.text biosdevname=0 net.ifnames=0 ",
  ...
  gencloud_boot_command_8_ppc64le = [
    "c<wait>",
    "linux /ppc/ppc64/vmlinuz inst.stage2=hd:LABEL=AlmaLinux-8-7-beta-1-ppc64le-dvd ro ",
    "inst.text biosdevname=0 net.ifnames=0 ",
