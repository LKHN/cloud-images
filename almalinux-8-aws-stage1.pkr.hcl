...
source "qemu" "almalinux-8-aws-stage1" {
  ...
  vm_name            = "almalinux-8-AWS-8.7-beta-1.x86_64.raw"
  boot_wait          = var.boot_wait
  boot_command       = var.aws_boot_command_8
}
...
build {
  ...
  post-processor "amazon-import" {
    ami_name        = "Alma 8.7-beta-1 internal use only {{isotime \"20060102\"}} x86_64"
    ...
    tags = {
      Name = "Alma 8.7-beta-1 internal use only {{isotime \"20060102\"}} x86_64"
    }
