...
url --url https://repo.almalinux.org/vault/8.3/BaseOS/x86_64/kickstart/
repo --name=BaseOS --baseurl=https://repo.almalinux.org/vault/8.3/BaseOS/x86_64/os/
repo --name=AppStream --baseurl=https://repo.almalinux.org/vault/8.3/AppStream/x86_64/os/
